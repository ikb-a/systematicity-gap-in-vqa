...
from vislang.vislang.models.lxmert.utils import (
    WEIGHTS_NAME,
    Config,
    cached_path,
    hf_bucket_url,
...
def norm_box(boxes, raw_sizes):
    ...
    raw_sizes = raw_sizes.unsqueeze(dim=1)  # add dim for boxes
    ...
    def inference(
        ...
        **kwargs,
        ...
        subset_kwargs = {
            ...
            "location": self.device,  #  Keep data on the same device as this model
        }
