...
#    imresize,
# )
# Ugly hack, get functions out of old version of scipy
...
# IAN: Why are colour channels transposed before processing with ResNet?
#      Silly, no they're not. They're just re-arranging channels, H, W
...
def run_batch(cur_batch, model):
    with torch.no_grad():
        ...
        # IAN NOTE: obsolete syntax, replaced with "with torch.no_grad()"
