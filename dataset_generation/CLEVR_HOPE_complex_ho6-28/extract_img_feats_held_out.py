...
if __name__ == "__main__":
    ...
    for features in [ClevrFeature.IMAGES, ClevrFeature.IEP_RESNET]:
        ...
        dm_kwargs = {
            "data_dir": f"{args.dir}/hdf5_held_out_CLEVR",
        ...
        dm_kwargs[f"dm_{generic_split_name}_images"] = f"{args.dir}/images/{args.split}"
    ...
    if not args.only_resnet:
        ...
        extract_frcnn(
            image_hdf5_path=f"{args.dir}/hdf5_held_out_CLEVR/{args.split}_v1.0_img/{generic_split_name}_ims.h5",
            outfile_path=f"{args.dir}/hdf5_held_out_CLEVR/{args.split}_v1.0_img/user_{generic_split_name}_vg_frcnn.h5",
        )
