...
# maybe this would be cleaner with a function decorator that takes
...
def answer_question(
    question, metadata, scene_struct, all_outputs=False, cache_outputs=True
):
    """
...
def answer_final_question(question, scene_struct):
    """
    Modification of answer_question that answers a question in the format
    of the final output
    """
    node_outputs = []
