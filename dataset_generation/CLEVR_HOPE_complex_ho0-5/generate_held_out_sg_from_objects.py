...
try:
    ...
    from held_out_utils_generate_questions import instantiate_templates_dfs
    from held_out_utils_generate_sg import (
        validate_scenegraph,
        create_scenegraph,
    ...
    print("\nERROR")
    print(
        "Cannot import either held_out_utils_generate_questions.py or held_out_utils_generate_sg.py"
    )
    print("You may need to add a .pth file to the site-packages of Blender's")
    print("bundled python with a command like this:\n")
    print(
        "echo $PWD >> $BLENDER/$VERSION/python/lib/python3.5/site-packages/held_out_clevr.pth"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_path",
        default="outputs/scenes_to_render/",
