...
images instead of features into the hdf5.

Rearrange into NxCxHxW

Divide images by 255 to convert to floats

This code only puts the image data into
the hdf5 format. Further processing on the user.

This is a modification of IEP code used by CLOSURE.
"""
...
#    imresize,
# )
# Get functions out of old version of scipy
from deprecated_scipy import imread
