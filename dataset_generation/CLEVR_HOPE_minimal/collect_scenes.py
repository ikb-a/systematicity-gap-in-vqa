...
parser.add_argument("--input_dir", default="test_output/scenes")
parser.add_argument("--output_file", default="test_output/CLEVR_misc_scenes.json")
parser.add_argument("--version", default="1.0")
parser.add_argument("--date", default="1/1/2024")
