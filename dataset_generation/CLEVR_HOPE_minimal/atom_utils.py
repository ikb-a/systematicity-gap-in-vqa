...
# Code should be run from blender for these imports to exist
...
def add_object(object_dir, name, scale, loc, theta=0, original_translate=True):
    """
    ...
    # This line causes the warning convertViewVec: called in an invalid context
    # Seems to be same problem as here: https://blenderartists.org/t/system-console-tells-me-convertviewvec-called-in-an-invalid-context/556943
    if original_translate:
        bpy.ops.transform.translate(value=(x, y, scale))
    else:
        # Based on the URL above, I believe this code is equivalent, sans warning:
        bpy.context.active_object.location += Vector((x, y, scale))
        # print("Using alternative, warning-free translate")
    # print("end translate")
...
def add_material(name, **properties):
    ...
    mat.node_tree.links.new(
        ...
        output_node.inputs["Surface"],  # type: ignore
    )
